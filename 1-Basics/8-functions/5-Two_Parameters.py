...
#Syntax
'''
def function_name(Parameter1, Parameter2): # Declaring a function
    code goes here
    code goes here

print(function_name(Argument1, Argument2)) # Calling a function
'''
...
def age_calculator(year_born, current_year):
    ...
    return f"You are/ or turning {age} years old this year."
# Calling a function with arguments
print(age_calculator(int(input("Year born: ")) , int(input("Current year: ")) ))